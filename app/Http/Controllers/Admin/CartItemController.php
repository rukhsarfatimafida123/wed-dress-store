...
{
    private $type     =  "cart_item";
    private $singular =  "Cart Item";
    private $plural   =  "Cart Items";
    private $view     =  "admin.cart_item.";
    private $action   =  "/admin/cart_item";
    private $db_key   =  "id";
    private $user = [];
    private $perpage = 10;
    ...
    function index(Request $request){
        ...
        $data['list']   =   CartItem::paginate($this->perpage)->toArray();
        $data['module'] = [
            'type'=>$this->type,
