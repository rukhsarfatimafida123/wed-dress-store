    ...
    <form action="{{$action}}" method="post" class="make_ajax" >
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="unit_price" class="control-label">unit_price</label>
                        <input type='text' name="unit_price" id="unit_price" class="form-control" required=""  value="{{@$row['unit_price']}}" />
                    </div>
                </div>
            </div>
        </div>
